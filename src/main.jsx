...
function Site({ data }) {
  ...
  const openReserve = (camera = null) => { setChosen(camera); setPlan('1-day'); setCopied(false); setConflict(null); setAvailabilityChecked(false); setCustomer({ name: '', phone: '', date: '', startTime: '09:00', endTime: '12:00', hours: 1 }); setModalOpen(true) }
